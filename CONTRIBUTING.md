...
Before opening a pull request, follow the local build and validation guidance
in [DEVELOPING.md](DEVELOPING.md). Do not add Teams credentials, network
integrations, private APIs, global event injection, or recordings to the
project. Test any Teams toggle against a call you are authorized to control
